...
module.exports = function (options , tmpDir) {
    ...
    this.startDownload = function(){
        ...
        parser.on('error', function(){
            ...
            var stats = fs.lstatSync(tmpDir + '/' + this.playlistFile);
            // Is it a directory?
            if (stats.isFile()) {
        ...
        try {
            // Query the entry
            stats = fs.lstatSync(tmpDir + '/' + this.playlistFile);
            // Is it a directory?
            if (stats.isFile()) {
                var readStream = fs.createReadStream(tmpDir + '/' + this.playlistFile);
